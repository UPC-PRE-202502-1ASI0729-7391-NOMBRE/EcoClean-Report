...
<div align="center">
  <img width=200 src="https://i.postimg.cc/dVxxgXBr/universidad-peruana-de-ciencias-aplicadas-upc-logo-png-seeklogo-402620.png"/>
</div>
...
| TF  | 02/12/25 | Diego Avalos | Capitulo V desarrollo avance del 4|
| TF  | 02/12/25 | Diego Avalos | Correción y actualización del frontend junto al backend|
| TF  | 01/12/25 | Joaquin Carranza | Capitulo V revisión de los sprints anteriores y desarrollo del 4|
| TF  | 03/12/25 | Joaquin Carranza | Correción y actualización del frontend y backend|
| TF  | 04/12/25 | Andree Cárdenas | Capitulo V desarrollo avance del 4|
| TF  | 02/12/25 | Andree Cárdenas | Corrección y actualización del Backend|
| TF  | 03/12/25 | Piero Velarde | Capitulo V desarrollo avance del 4|
| TF  | 02/12/25 | Piero Velarde | Corrección y actualización del Backend junto a corrección del frontend|
...
|---------------------|---------------------|--------------|
  | **Comunica oralmente con efectividad a diferentes rangos de audiencia.** | **Mathias Andree Cárdenas Huamán**<br>• *TB1:* Expliqué objetivos, propuesta de valor y realicé entrevistas con lenguaje claro y empático.<br>• *TP1:* Expuse avances del módulo de mensajería y arquitectura del sistema, adaptando el lenguaje a docentes y autoridades.<br>• *TB2:* Coordiné oralmente los avances del Capítulo V del Sprint 3, explicando los puntos a desarrollar.<br>• *TTF:* Corregi los errores ortograficos de las entregas pasadas y una actualización del backend y avances del Capítulo V del Sprint 4. <br><br>**Joaquín Enrique Carranza Tesén**<br>• *TB1:* Presenté el diagrama de base de datos y realicé entrevistas adaptando el lenguaje técnico y no técnico.<br>• *TP1:* Expuse avances de la landing page, coordinando y comunicando mejoras con lenguaje accesible.<br><br>• *TB2:* Adapté mi discurso según la audiencia. Con mi equipo técnico, fui preciso y utilicé jerga específica de desarrollo (APIs, frameworks) para discutir la arquitectura. Al mismo tiempo, me encargué de justificar las decisiones de diseño y la metodología del proyecto, asegurando la coherencia y el rigor del trabajo final. Por último, al interactuar con usuarios y clientes, traduje las funciones complejas en beneficios claros y prácticos, enfocándome en la experiencia de usuario durante la demostración de la aplicación.<br>• *TF:* Fui el puente esencial entre la estrategia documentada en el informe y la ejecución técnica completa, garantizando la operatividad total de la aplicación mediante la implementación fluida de la conexión frontend y backend. <br>**Diego Andrés Ávalos Córdova**<br>• *TB1:* Presenté arquitectura de información, navegación y prototipos de forma clara para diferentes audiencias.<br>• *TP1:* Expliqué implementación de la Web App, tendencias, mapas y registro, apoyándome en videos y capturas.<br>• *TB2:* Guié oralmente el despliegue del backend, resolviendo dudas técnicas del equipo.<br> *TF:* Logré la comunicación oral efectiva al adaptar el nivel de detalle de mi mensaje para cada audiencia, enfatizando los beneficios del despliegue en la nube (escalabilidad y costo) ante la gerencia y las decisiones técnicas de desarrollo (frontend/backend) ante los equipos de ingeniería. <br>**Sebastián Gabriel Zúñiga Calle**<br>• *TB1:* Expliqué SCM, planificación ágil y despliegue, adaptando lenguaje técnico y práctico según público.<br><br>**Piero Alberto Velarde Luyo**<br>• *TB1:* Expuse User Personas, Journey Map, Empathy Map y wireframes con lenguaje accesible para todo el equipo.<br>• *TP1:* Presenté mejoras del sprint y despliegue de Web App y FakeAPI.<br> • *TB2:* Expliqué al equipo el proceso de despliegue del frontend y backend, ajustando el nivel técnico según cada integrante. También guié el uso adecuado del Git Flow. <br> *TF* Logré la comunicación oral efectiva al adaptar el enfoque del despliegue en la nube, destacando los beneficios estratégicos (costo, disponibilidad) ante la gerencia y detallando la arquitectura del despliegue y la documentación ante el equipo técnico. | **Mathias:**<br>• *Conclusión TB1:* Logré transmitir ideas con claridad y empatía, adaptándome según la audiencia.<br>• *Conclusión TP1:* Fortalecí mi capacidad para explicar aspectos técnicos de manera comprensible y efectiva.<br>• *TB2:* Mi comunicación oral permitió coordinar mejor el desarrollo del backend y asegurar que todos comprendieran los cambios, ajustando la información según el nivel técnico del equipo.<br><br>**Joaquín:**<br>• *Conclusión TB1:* Adaptar el lenguaje según el público permitió transmitir conceptos técnicos con claridad.<br>• *Conclusión TP1:* La comunicación oral fue clave para coordinar decisiones del sprint y validar avances con docentes.<br>• *Conclusión TB2:* La comunicación oral efectiva en ingeniería de software no es solo saber hablar, sino saber a quién se le habla. Mi experiencia me enseñó que para cualquier proyecto exitoso, es tan crucial desarrollar la aplicación correctamente como ser capaz de articular su valor y su funcionamiento en el idioma que mejor entienda cada rango de audiencia.<br>• *Conclusión TF:* Mi participación aseguró la coherencia total del proyecto, traduciendo la dirección estratégica del informe en una aplicación plenamente funcional gracias a la integración exitosa de su frontend y backend. <br>**Diego:**<br>• *Conclusión TB1:* Explicar arquitectura y navegación reforzó mi habilidad para comunicar a públicos diversos.<br>• *Conclusión TP1:* Presentar avances técnicos me permitió mejorar mi claridad al exponer procesos complejos.<br>• *TB2:* Mi comunicación oral ayudó a que el equipo comprendiera mejor los procesos del backend y permitió coordinar el desarrollo y despliegue con mayor claridad.<br> *Conclusión TF:* En consecuencia, la comunicación fue exitosa porque traduje la complejidad técnica de la arquitectura y el cloud en información estratégica y funcional que fue relevante y clara para todos los rangos de audiencia. <br>**Sebastián:**<br>• *Conclusión TB1:* Fortalecí mi capacidad de presentar contenido técnico de forma clara y estructurada.<br><br>**Piero:**<br>• *Conclusión TB1:* Aprendí a adaptar mi comunicación para que elementos UX fueran comprendidos por el equipo.<br>• *Conclusión TP1:* Mejoré mi capacidad para explicar mejoras y decisiones de diseño de manera efectiva.<br> • *Conclusión TB2:* Mi comunicación oral facilitó despliegues más ordenados y redujo errores al adaptar las indicaciones al nivel técnico de cada miembro. <br> *Conclusión TF:* La comunicación fue exitosa porque traduje la complejidad de la infraestructura en la nube y la documentación en información clara que aseguró la comprensión y el alineamiento de todos los rangos de audiencia. |
| **Comunica por escrito con efectividad a diferentes rangos de audiencia.** | **Mathias Andree Cárdenas Huamán**<br>• *TB1:* Redacté el informe combinando contenido técnico y lenguaje accesible.<br>• *TP1:* Documenté historias de usuario, requerimientos y mensajería con claridad y estructura.<br>• *TB2:* Actualicé por escrito las conclusiones del Sprint 3, redactando contenido claro y organizado.*TF:* <br>• Actualicé por escrito el sprint backlog 4 junto a una coordinación para actualizar y mejorar el avance del backend <br><br>**Joaquín Enrique Carranza Tesén**<br>• *TB1:* Elaboré documentos técnicos, cuestionarios y resúmenes comprensibles para todos.<br>• *TP1:* Redacté reportes de avances y documentación del frontend y landing page.<br>• *TB2:* Segmente y adapte mi estilo según el documento que creaba. Para mi equipo, elaboré documentación técnica con jerga específica (UML, ERD) y gran detalle, enfocándome en el mantenimiento. Para los evaluadores, redacté el Informe Final con un lenguaje formal y académico, centrándome en la justificación de la metodología y los resultados. Finalmente, para los usuarios, produje manuales y FAQs con un lenguaje simple y directo, priorizando la usabilidad de la aplicación y la facilidad de comprensión.<br>• *TF:* Al estructurar mi mensaje en niveles de detalle que claramente diferenciaron el impacto estratégico (para gerencia) del detalle técnico de la integración frontend-backend (para desarrolladores), asegurando la relevancia para cada audiencia. <br>**Diego Andrés Ávalos Córdova**<br>• *TB1:* Redacté Style Guide, Arquitectura y Navegación manteniendo claridad para públicos diversos.<br>• *TP1:* Documenté despliegue, integraciones y funcionalidades con evidencia visual clara.<br>• *TB2:* Documenté el despliegue del backend y las funcionalidades implementadas.<br> *TF:* Cumplí con la comunicación escrita efectiva al estructurar informes y documentación técnica diferenciada; resaltando el ROI y la eficiencia del cloud para ejecutivos y detallando la arquitectura full stack para el equipo de desarrollo, asegurando la claridad y relevancia para cada lector. <br>**Sebastián Gabriel Zúñiga Calle**<br>• *TB1:* Documenté arquitectura, planificación y evidencias con estilo formal y organizado.<br><br>**Piero Alberto Velarde Luyo**<br>• *TB1:* Documenté entregables UX con lenguaje accesible.<br>• *TP1:* Redacté evidencia de mejoras y despliegue de Web App, Landing Page y FakeAPI.<br>• *TB2:* Elaboré instrucciones claras para el despliegue del frontend y backend, además de lineamientos escritos sobre Git Flow. <br> *TF:* Cumplí con la comunicación escrita efectiva al crear documentación dual que abordó la justificación estratégica del despliegue en la nube para ejecutivos y detalló las especificaciones técnicas de la conexión y configuración para el equipo de operaciones. | **Mathias:**<br>• *Conclusión TB1:* Fortalecí mi capacidad de redactar documentos técnicos comprensibles.<br>• *Conclusión TP1:* Logré transmitir información técnica de manera precisa y accesible.<br>• *TB2:* La redacción de conclusiones y documentación técnica fortaleció mi capacidad de comunicar información escrita de forma organizada y comprensible.<br><br>**Joaquín:**<br>• *Conclusión TB1:* La escritura técnica y clara permitió asegurar coherencia y comprensión en el equipo.<br>• *Conclusión TP1:* La documentación escrita facilitó coordinación y claridad en el proceso del sprint.<br>• *Conclusión TB2:* Este proyecto se basó en el principio de un documento, un propósito, una audiencia. Logré transmitir información técnica compleja, justificaciones metodológicas y guías de uso al diferenciar formatos (documentación técnica, informe final, manuales) y asegurar que el estilo y el contenido de cada pieza escrita fuera relevante y accesible para su lector específico, garantizando así la calidad y comprensión del proyecto a todos los niveles.<br>• *Conclusión TF:* La comunicación escrita fue exitosa porque traduje la complejidad técnica en valor estratégico usando un formato adaptable que garantizó la comprensión por todos los rangos de audiencia.<br>**Diego:**<br>• *Conclusión TB1:* Mejoré mi habilidad para explicar conceptos técnicos de forma ordenada y accesible.<br>• *Conclusión TP1:* Redactar documentación compleja reforzó mi capacidad de comunicación escrita profesional.<br>• *TB2:* La documentación escrita que elaboré permitió mantener claridad sobre el trabajo técnico realizado y facilitó la comprensión del backend para el equipo y revisores.<br> *Conclusión TF:* El éxito de mi comunicación escrita se basó en la habilidad de sintetizar la complejidad del despliegue en la nube y la arquitectura full stack en formatos que informaron y persuadieron a todos los rangos organizacionales. <br>**Sebastián:**<br>• *Conclusión TB1:* La redacción formal garantizó trazabilidad y claridad en el proceso del proyecto.<br><br>**Piero:**<br>• *Conclusión TB1:* Mejoré mi capacidad para explicar visuales y procesos de diseño de forma escrita.<br>• *Conclusión TP1:* Aseguré claridad y pertinencia en toda la evidencia escrita del sprint.<br> • *Conclusión TB2:* La documentación escrita estandarizó los procesos del equipo y permitió un flujo de trabajo más consistente. <br> • *Conclusión TF:* El éxito de mi comunicación escrita se basó en la habilidad de sintetizar la documentación y los procedimientos de despliegue en formatos que fueron precisos, accionables y relevantes para cada lector.|
...
| US13 | EP05 | Asignación de roles                      | Como Administrador EcoSmart, quiero poder asignar roles a los diferentes usuarios para controlar sus permisos en el panel.                                      | **Escenario Positivo - Asignación exitosa:** Dado que el Administrador está en el panel de "Asignación de roles", cuando selecciona un usuario y un nuevo rol 'ADMIN', entonces el sistema actualiza el permiso del usuario.<br><br>**Escenario Negativo - Usuario no encontrado:** Dado que el Administrador busca un usuario, cuando ingresa un correo que no existe, entonces el sistema muestra un mensaje de "Usuario no encontrado".           |
| US14 | EP05 | Gestión de municipios                    | Como Administrador EcoSmart, quiero poder registrar, ver y gestionar los municipios que usarán la plataforma.                                                   | **Escenario Positivo - Registro exitoso:** Dado que el Administrador está en la sección "Municipios" y llena los campos 'Nombre' y 'Departamento', cuando hace clic en "Registrar municipio", entonces el nuevo municipio aparece en la lista.<br><br>**Escenario Negativo - Datos incompletos:** Dado que el Administrador intenta registrar un municipio, cuando deja el campo 'Nombre' vacío, entonces el sistema muestra un error de validación. |
...
| Género: Masculino |
| Edad: 22 años |
| Link de la entrevista (YouTube): [https://upcedupe-my.sharepoint.com/:v:/g/personal/u20191b935_upc_edu_pe/IQAXtxcs1XqzSJYkQVG--VgkASzIsG1gOLZSTjJAg20pCvY?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D&e=PCqe3V](https://upcedupe-my.sharepoint.com/:v:/g/personal/u20191b935_upc_edu_pe/IQAXtxcs1XqzSJYkQVG--VgkASzIsG1gOLZSTjJAg20pCvY?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D&e=PCqe3V) | 
...
| Género: Masculino |
| Edad: 20 años |
| Link de la entrevista (YouTube): [https://upcedupe-my.sharepoint.com/:v:/g/personal/u20191b935_upc_edu_pe/IQDwrXbJjLdVQ7x2T-eZ-7Q3AZbaXKXN_TP97piJDzjs5zs?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D&e=DfWoDw](https://upcedupe-my.sharepoint.com/:v:/g/personal/u20191b935_upc_edu_pe/IQDwrXbJjLdVQ7x2T-eZ-7Q3AZbaXKXN_TP97piJDzjs5zs?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D&e=DfWoDw) | 
...
[https://upcedupe-my.sharepoint.com/:v:/g/personal/u202313922_upc_edu_pe/IQAoYxDEg4_zS6aNgim-4vC7AYATa9GM9SZfirPvxokWYe0?e=szsS4b&nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D](https://upcedupe-my.sharepoint.com/:v:/g/personal/u202313922_upc_edu_pe/IQAoYxDEg4_zS6aNgim-4vC7AYATa9GM9SZfirPvxokWYe0?e=szsS4b&nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D)

## 5.5. Video About-The-Team

[https://upcedupe-my.sharepoint.com/:v:/g/personal/u202313922_upc_edu_pe/IQCEIiqTuolZQo1Cv5KvOHaVAXb06SJjtTUG3PX5LpMy9zQ?e=zAjMRf&nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D](https://upcedupe-my.sharepoint.com/:v:/g/personal/u202313922_upc_edu_pe/IQCEIiqTuolZQo1Cv5KvOHaVAXb06SJjtTUG3PX5LpMy9zQ?e=zAjMRf&nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D)
